...
const score=100;//we don't need to declear datatype in java ..it itself identifies the datatype and getys the output..
...
//we use "n"at the end pof bigint as it is a rule of java while using bigint.
